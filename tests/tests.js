...
describe("words()", function() {
  ...
  it("counts tabs", function() {
    var expectedCounts = { hello: 1, world: 1 };
    expect(myApp.words("hello\tworld")).to.eql(expectedCounts);
  });
  ...
  it("handles properties that exist on Object’s prototype", function() {
    ...
    expect(myApp.words("reserved words like prototype and toString ok?")).to.eql(expectedCounts);
  });
});